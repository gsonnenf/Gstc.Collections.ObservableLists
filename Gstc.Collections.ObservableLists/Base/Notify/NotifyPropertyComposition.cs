...
namespace Gstc.Collections.ObservableLists.Base.Notify {
    ...
    /// </summary>
    public class NotifyPropertyComposition : INotifyPropertyChanged {
        ...
        public NotifyPropertyComposition(object parent) { Parent = parent; }

        public virtual void OnPropertyChanged(PropertyChangedEventArgs e) => PropertyChanged?.Invoke(this, e);
